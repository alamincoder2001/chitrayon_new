...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="sales" class="group-head" @click="onClickGroupHeads"> <strong>Orders</strong>
                <ul ref="sales">
                    <li><input type="checkbox" class="access" value="sales/product" v-model="access"> Order Entry</li>
                    ...
                    <li><input type="checkbox" class="access" value="salesrecord" v-model="access"> Orders Record</li>
        ...
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="salesReports" class="group-head" @click="onClickGroupHeads"> <strong>Orders Reports</strong>
                <ul ref="salesReports">
                    <li><input type="checkbox" class="access" value="salesinvoice" v-model="access"> Orders Invoice</li>
