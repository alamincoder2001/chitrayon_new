				 ...
				 <form v-on:submit.prevent="addToCart">
					<div class="row">
						...
						<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="col-xs-4 control-label no-padding-right">Stock Status</label>
									<div class="col-xs-8">
										<input type="text" id="productStock" placeholder="stock" class="form-control" v-model="productStock" readonly v-bind:style="{color: productStock > 0 ? 'green' : 'red'}">
									</div>
									<div class="col-xs-4" style="padding-right:0px">
										<input type="text" id="stockUnit" placeholder="Unit" class="form-control" v-model="selectedProduct.Unit_Name">
									</div>
									<div class="col-xs-4" style="padding-left:0px">
									<input type="password" ref="productPurchaseRate" class="form-control" v-model="selectedProduct.Product_Purchase_Rate" v-on:mousedown="toggleProductPurchaseRate" v-on:mouseup="toggleProductPurchaseRate"  readonly title="Purchase rate (click & hold)" style="text-align: center;">
									</div>
								</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input class="form-control" list="colorList" v-model="productInformation.colorName"> 
									<datalist id="colorList">
										<div  v-for="item in colors">
											<option v-bind:value="item.color_name">
										</div>										
									</datalist>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"><span style="font-size:13px"> Paper Type</span></label>
								<div class="col-xs-8">
									<input class="form-control" list="paperList" v-model="productInformation.paperType"> 
							...
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right">Long Size</label>
								<div class="col-xs-8">
									<input class="form-control" v-model="productInformation.longSize"> 
								</div>
							</div>

							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right">Wide Size</label>
								<div class="col-xs-8">
									<input class="form-control" v-model="productInformation.wideSize"> 
								</div>
							</div>

							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right">Body Des.</label>
								<div class="col-xs-8">
									<input class="form-control" v-model="productInformation.bodyDesign"> 
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right">GSM</label>
								<div class="col-xs-8">
									<input class="form-control" v-model="productInformation.gsm"> 
								</div>
							</div>
							<div class="form-group">
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:15%;color:#000;">Product Name</th>
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						<tr v-for="(product, sl) in cart">
							...
							<td style="text-align:left">
								<span v-if="product.colorName != '' "><b>Color: </b>{{ product.colorName }},&nbsp;</span>
								<span v-if="product.paperType != '' "><b>Paper: </b>{{ product.paperType }},</span><br>
								<span v-if="product.longSize != '' "><b>Long: </b>{{ product.longSize }},&nbsp;</span>
								<span v-if="product.wideSize != '' "><b>Wide: </b>{{ product.wideSize }},</span><br>
								<span v-if="product.bodyDesign != '' "><b>Body: </b>{{ product.bodyDesign }},&nbsp;</span>
								<span v-if="product.gsm != '' "><b>GSM: </b>{{ product.gsm }}</span>
							</td>
		...
		methods:{
			...
			addToCart(){
				let product = {
					...
					colorName : this.productInformation.colorName,
					paperType: this.productInformation.paperType,
					longSize: this.productInformation.longSize,
					wideSize: this.productInformation.wideSize,
					bodyDesign: this.productInformation.bodyDesign,
					gsm: this.productInformation.gsm,
				}
				...
				if(product.paperType == ''){
					alert('Enter paper type');
					return;
				}
				if(product.longSize == ''){
					alert('Enter long size');
					return;
				}
				if(product.wideSize == ''){
					alert('Enter wide size');
					return;
				}
				if(product.bodyDesign == ''){
					alert('Enter body design ');
					return;
				}
				if(product.gsm == ''){
					alert('Enter GSM  ');
