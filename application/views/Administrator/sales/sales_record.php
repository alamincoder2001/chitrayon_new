	...
	<div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'order' ? '' : 'none'}">
					<label>Order Status</label>
					<select class="form-control" v-model="orderType">
						<option value="" selected>All</option>
						<option value="p">Pending Order</option>
						<option value="on">On processing</option>
						<option value="w">On The Way</option>
					...
					<tbody>
						<tr v-for="sale in sales">
							...
							<td style="text-align:left;">
								<span v-if="sale.orderStatus == 'p' ">
									<button type="button" class="button" @click="updateStatus(sale.SaleMaster_SlNo, 'on')">
										Pending 
                                 	</button>
								</span>
								<span v-else-if="sale.orderStatus == 'on' ">
									<button type="button" class="button" @click="updateStatus(sale.SaleMaster_SlNo, 'w')">
										On Processing 
                                 	</button>
								</span>
								<span v-else-if="sale.orderStatus == 'w' ">
									<button type="button" class="button" @click="updateStatus(sale.SaleMaster_SlNo, 'd')">
										On The way
                                 	</button>
								</span>
								<span v-else-if="sale.orderStatus == 'd' ">Delivered</span>
								<span v-else-if="sale.orderStatus == 'c' ">Cancelled</span>
	...
	new Vue({
		...
		data(){
			return {
				...
				sales: [],
				searchTypesForRecord: ['', 'user', 'customer', 'employee','order'],
