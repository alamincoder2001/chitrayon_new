            ...
            <div id="invoiceContent">
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td style="text-align:left">
                                        ...
                                        <span v-if="product.pageName != '' "><b>Paper: </b>{{ product.pageName }},</span><br>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <strong style="margin:0;">Note: </strong>
                        <span>{{sales.SaleMaster_Description}}</span>
                        <div style="display:flex;margin-top:10px;">
                            <ul style="list-style:none;padding:0; padding-left:5px;">
                                <li>*মাল ডেলিভারির সময় অবশ্যই মেমো আনতে হবে।</li>
                                <li>*এই কাজ এর দায়-ভার কাষ্টমার হিসেবে বুঝিয়া শুনিয়া প্রদান করলাম।</li>
                                <li>*অর্ডারের ১৫ দিনের মধ্যে না নিলে চিত্রায়ন কতৃপক্ষ দায় থাকবে না।</li>
                                <li>*অর্ডারের ক্ষেত্রে ৭৫% এ্যাডভান্স ও ডেলিভারির সময় ১০০% পেমেন্ট দিয়ে মাল বুঝিয়া নিতে হবে, পরবর্তীতে কোনো অভিযোগ গ্রহণ যোগ্য না।</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <div class="row" style="display:flex;">
                            <div style="padding:0;width:36%;">
                                <img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:60px;width:98%;" />
                                <p style="font-size:10px;font-weight:700;margin:0;margin-top:-2px;padding-left:10px;"><span>Cell: </span>+88 01788-684058 <br /> 
                                chitrayongraphics@gmail.com<p>
                            </div>
                            <div style="padding-top:15px;font-size:10px;width:20%;margin-left:3px;">
                            ...
                            <div style="padding-top:15px;font-size:10px;width:20%;margin-left:5px;">
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-xs-3" style="padding:0;padding-left:5px;">
                                                    <img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:100px;width:100%;" />
                                                    <p style="font-size:12px;margin:0;padding-left:10px;">+88 01788-684058<br> 
                                                    chitrayongraphics@gmail.com<p>
                                                </div>
                                                <div class="col-xs-3" style="padding:0;font-size:12px;padding-left: 26px;">
                                                    <span style="font-weight:bold;">Head Office:</span> <br>
                                                    48/A-B, Baytul Khair <br>
                                                    Bhaban Purana Paltan <br>
                                                    Dhaka-1000 <br>
